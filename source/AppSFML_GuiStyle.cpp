...
void AppSFMLDraw::SetupGuiStyle()
{
	...
	colors[ImGuiCol_Text]                   = ImVec4(0.79f, 0.83f, 1.00f, 0.97f);
	colors[ImGuiCol_TextDisabled]           = ImVec4(0.59f, 0.62f, 0.75f, 0.61f);
	...
	colors[ImGuiCol_Border]                 = ImVec4(0.13f, 0.13f, 0.20f, 0.81f);
	colors[ImGuiCol_BorderShadow]           = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	colors[ImGuiCol_FrameBg]                = ImVec4(0.80f, 0.83f, 1.00f, 0.11f);
	colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.67f, 0.71f, 1.00f, 0.35f);
	colors[ImGuiCol_FrameBgActive]          = ImVec4(0.70f, 0.80f, 1.00f, 0.48f);
	...
	colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.79f, 0.82f, 1.00f, 0.67f);
	...
	colors[ImGuiCol_Header]                 = ImVec4(0.58f, 0.58f, 0.90f, 0.07f);
	colors[ImGuiCol_HeaderHovered]          = ImVec4(0.45f, 0.45f, 0.90f, 0.17f);
	colors[ImGuiCol_HeaderActive]           = ImVec4(0.53f, 0.53f, 0.87f, 0.24f);
	colors[ImGuiCol_Separator]              = ImVec4(0.49f, 0.49f, 0.50f, 1.00f);
	colors[ImGuiCol_SeparatorHovered]       = ImVec4(0.60f, 0.65f, 0.70f, 1.00f);
	colors[ImGuiCol_SeparatorActive]        = ImVec4(0.70f, 0.79f, 0.90f, 1.00f);
